...
Do not retry a real command failure with broader permissions. Do not use an
equivalent direct command chain as fallback.
...
Local execution configuration cannot change reviewed SHAs, findings, severity,
