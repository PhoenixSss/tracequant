...
| `tools/agent_workflow/skill_path_audit.py` | `c9465df1fd2550ddb4a6c6e427daa6683a30dd31` | `tools/lck/skill_audit.py` | restored/adapted | Reworked to audit one canonical `.agents` Skill source plus its mirrored provider Skill packages; Task #377 restored the package-to-package provider mirror audit. |
...
| `.claude/skills/feature-completion-audit/SKILL.md` | `534321b46cd4e3da8445c9c5d2e258da42594339` | `.claude/skills/feature-completion-audit/SKILL.md` | restored as provider mirror | Task #377 replaced the thin adapter with a self-contained mirror of the canonical Skill package; the single declared provider difference is the appended Claude-only `## Execution model` section. |
| `.claude/skills/task-closeout/SKILL.md` | `082e681e1e5e655c8e979599cfe29882b755d764` | `.claude/skills/task-closeout/SKILL.md` | restored as provider mirror | Task #377 replaced the thin adapter with a self-contained mirror of the canonical Skill package; the single declared provider difference is the omitted Codex-only `## Execution route contract` section. |
| `.claude/skills/task-delivery-runner/SKILL.md` | `1e7d95550fcc41cb69147a6a09140d515891c7ff` | `.claude/skills/task-delivery-runner/SKILL.md` | restored as provider mirror | Task #377 replaced the thin adapter with a self-contained mirror of the canonical Skill package (`SKILL.md` plus `references/*.md`); the single declared provider difference is the omitted Codex-only `## Execution route contract` section. |
| `.claude/skills/task-pr-review-runner/SKILL.md` | `2dbf4473b0bfcb77057df9da5a7fea4e6b7ca0e4` | `.claude/skills/task-pr-review-runner/SKILL.md` | restored as provider mirror | Task #377 replaced the thin adapter with a self-contained mirror of the canonical Skill package; the single declared provider difference is the omitted Codex-only `## Execution route contract` section. |
...
| `.github/ISSUE_TEMPLATE/bug.yml` | `5ae205ca966e9505119c00f8eaf6f4ebb5e1eac5` | `.github/ISSUE_TEMPLATE/bug.yml` | retained unchanged | The current Bug form is byte-identical to the authoritative source and remains the contract loaded by `tools/lck/bug_policy.py`. |
| `.github/ISSUE_TEMPLATE/config.yml` | `8005e3226730ef74f37ae9614ba94a1bb879b4a0` | `.github/ISSUE_TEMPLATE/config.yml` | retained unchanged | Repository Issue-form chooser configuration is byte-identical and required no overlay. |
| `.github/ISSUE_TEMPLATE/documentation.yml` | `d337abab2e720c3f84a628a73e075aef096e3c17` | `.github/ISSUE_TEMPLATE/documentation.yml` | retained unchanged | The current Documentation form is byte-identical to the authoritative source and remains the contract loaded by `tools/lck/documentation_policy.py`. |
| `.github/ISSUE_TEMPLATE/epic.yml` | `ff3a2e739a3ae0300db0d15e532da360aca9c72b` | `.github/ISSUE_TEMPLATE/epic.yml` | retained unchanged | The non-leaf Epic form is byte-identical; LCK resolves it as a non-leaf profile and does not overlay it. |
| `.github/ISSUE_TEMPLATE/feature.yml` | `8c2e55aad1b2305b5db1f249328fb705e59bc13c` | `.github/ISSUE_TEMPLATE/feature.yml` | current v2 file retained | The historical form was intentionally not overlaid. Current Feature authoring/project semantics own this non-leaf form; LCK only recognizes its canonical type label. |
| `.github/ISSUE_TEMPLATE/research.yml` | `cdb61d2b5a26e8508bd6135e201d45a71131037e` | `.github/ISSUE_TEMPLATE/research.yml` | retained unchanged | The current Research form is byte-identical to the authoritative source and remains the contract loaded by `tools/lck/research_policy.py`. |
| `.github/ISSUE_TEMPLATE/task.yml` | `ca7d13fea03ad2d5c8cd512f6db6297f8888e87d` | `.github/ISSUE_TEMPLATE/task.yml` | current v2 file retained | The historical Task form was intentionally not overlaid. The current v2 form remains the canonical Critical Outcome contract input loaded by LCK. |
| `.github/pull_request_template.md` | `d9620d336755c740700d8fa68c10f3c3917d5176` | `.github/pull_request_template.md` | retained unchanged | The PR template is byte-identical and continues to document the human Review/Merge boundary. |
