...
| Candidate Refresh merge/session/abort and owned recovery | `refresh.py` | `review_workspace.py`, `delivery.py`, `effects.py` |
...
- `test_candidate_refresh.py` — current-main integration, exact merge identity, abort, staleness, and partial recovery.
